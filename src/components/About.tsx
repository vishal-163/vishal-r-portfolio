...
const About = () => {
  ...
  return (
    <section id="about" className="px-4 sm:px-6 md:px-8 py-16 md:py-28 relative">
      <div className="max-w-7xl mx-auto" ref={ref}>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {highlights.map((item, i) => (
            ...
            >
              <div className="w-10 h-10 md:w-14 md:h-14 mx-auto mb-3 md:mb-4 rounded-xl bg-neon-blue/10 flex items-center justify-center group-hover:bg-neon-blue/20 transition-colors">
                <item.icon className="w-5 h-5 md:w-7 md:h-7 text-neon-blue" />
              </div>
              <h3 className="font-heading font-semibold text-xs sm:text-sm md:text-base mb-1 md:mb-2">{item.title}</h3>

...
===== PROFILE: VISHAL R =====
- Role: Aspiring Full Stack Developer, 7th sem of final year CSE student at KSIT Bangalore (Graduating 2027).
    ...
    req.on('end', async () => {
      try {
        ...
        if (responseText) {
              ...
              supabase
                ...
                .then(({ error }) => {
                  if (error) {
                    ...
                    if (error.code === '42703') {
                      console.warn('ACTION REQUIRED: You need to add the "local_time" column to your Supabase table.');
                    }
                  } else {
          ...
          console.warn('Empty output from Groq:', data);
          res.statusCode = 500;
